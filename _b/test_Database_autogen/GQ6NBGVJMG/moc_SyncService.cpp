...
void SyncService::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->syncComplete((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->syncError((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SyncService::*)(const QString & )>(_a, &SyncService::syncComplete, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (SyncService::*)(const QString & , const QString & )>(_a, &SyncService::syncError, 1))
            return;
    }
}
...
// SIGNAL 0
void SyncService::syncComplete(const QString & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void SyncService::syncError(const QString & _t1, const QString & _t2)
{
